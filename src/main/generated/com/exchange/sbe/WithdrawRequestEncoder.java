...
public final class WithdrawRequestEncoder
{
    ...
    private final WithdrawRequestEncoder parentMessage = this;
    ...
    public WithdrawRequestEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public WithdrawRequestEncoder wrapAndApplyHeader(
    ...
    public WithdrawRequestEncoder userId(final long value)
    {
    ...
    public WithdrawRequestEncoder currencyId(final int value)
    {
    ...
    public WithdrawRequestEncoder amount(final long value)
    {
    ...
    public WithdrawRequestEncoder seqId(final long value)
    {
